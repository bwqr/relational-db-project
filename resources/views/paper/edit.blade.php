...
@section('view')
    <section class="centered-app">
        <div class="container">
            <div class="">
                <div class="title">
                    <h1 class="is-size-3 has-text-centered">Edit Paper</h1>
                </div>
                <form action="/paper/edit/{{$paper['id']}}" method="post" id="paper-post">
                    <div class="mdc-text-field">
                        <input type="text" id="title" name="title" class="mdc-text-field__input" value="{{$paper['title']}}" required>
                        <label class="mdc-floating-label" for="title">Title</label>
                        <div class="mdc-line-ripple"></div>
                    </div>
                    <div class="mdc-text-field">
                        <input type="number" id="result" name="result" class="mdc-text-field__input" value="{{$paper['result']}}" required>
